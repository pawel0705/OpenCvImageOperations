# Metoda Gurner-Farneback, gęsty przepływ optyczny. Wykrywanie obiektów na kamerze.
...
while(cap.isOpened()):
    ...
    _, mask = cv.threshold(mag, 5, 255, cv.ADAPTIVE_THRESH_MEAN_C)
    ...
    time_caps.append(stop - start)

    
sum_time = sum(time_caps)
mean_time = sum_time / iterator
